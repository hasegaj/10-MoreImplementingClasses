    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        pt = rg.Point(intersection_center.x + width/2, intersection_center.y + letter_thickness/2)
        pt2 = rg.Point(intersection_center.x - width/2, intersection_center.y - letter_thickness/2)
        pt3 = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y)
        pt4 = rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y + height)

        self.h_rect = rg.Rectangle(pt, pt2)
        self.v_rect = rg.Rectangle(pt3, pt4)
